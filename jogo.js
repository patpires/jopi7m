...
Telas.GAME_OVER = {
  desenha() {
    ...
    if (medalha) {
      ...
      contexto.fillStyle = 'white';
      contexto.fillText(`${globais.placar.pontuacao} `, canvas.width / 6 + 2, canvas.height / 6 -10);
      contexto.fillText(`${globais.placar.recorde}`, canvas.width / 6 + 2, canvas.height / 6 - 7);
    }
  },
  atualiza() {},
  click() {
