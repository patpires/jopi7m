...
Telas.GAME_OVER = {
  desenha() {
    ...
    if (medalha) {
      ...
      contexto.fillStyle = 'white';
      contexto.fillText(`${globais.placar.pontuacao} `, canvas.width / 4 + 2, canvas.height / 4 -10);
      contexto.fillText(`${globais.placar.recorde}`, canvas.width / 4 + 2, canvas.height / 4 - 7);
    }
  },
  atualiza() {},
  click() {
